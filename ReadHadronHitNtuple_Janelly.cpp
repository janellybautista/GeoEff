...
void ReadHadronHitNtuple_Janelly()
{
  gROOT->Reset();

  // Input FDroot file
  TString FileIn = "/Users/janellybautista/Desktop/GeoEff/DUNE_ND_GeoEff/app/Output_FDGeoEff_2293930_80.root";
  //
  ...
  // Loop all events
  //for (Int_t i_iwritten : *iwritten_vec) //original
...
void ReadHadronHitNtuple_FD()
{
  ...
  */
  ...
  for ( int ientry = 0; ientry < nentries; ientry++ )
  {
    ...
    gPad->Modified();
    gSystem->ProcessEvents();
    gSystem->Exec("mkdir -p HadronHitPlots_FD");
